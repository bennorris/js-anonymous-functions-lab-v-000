...
function play() {
  $('#play').on('click', playDatTrack);
}

function playDatTrack(e) {
...
function pause() {
  $('#pause').on('click', pauseDatTrack);
}

function pauseDatTrack(e) {
  $('#songPaused').html(songToPlay + " is paused");
}

function show() {
  $('#show').on('click', showThoseTracks);
}

function showThoseTracks() {
  var songs = "";
